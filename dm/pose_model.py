...
def compute_error_in_q(args, dl, model, device, results, batch_size=1):
    ...
    for batch in dl:
        ...
        # #pose_avg处理输出预测的位姿 
        # from dataset_loaders import load_7Scenes
        # # args.pose_avg_stats_mode_pred_eval=1
        # print('\n\n\n ========== pose_avg_stats_mode_pred_eval = {}'.format(args.pose_avg_stats_mode_pred_eval))
        # if args.pose_avg_stats_mode_pred_eval==-1:
        #     print('Not using pose_avg for predicted pose')
        # elif args.pose_avg_stats_mode_pred_eval == 0: # nerf baest
        #     pose_avg_file = np.loadtxt('/home/jialu/zeroshot123cycle0524/data/7Scenes/heads/pose_avg_stats_nerf_best.txt')
        #     predict_pose, pose_avg = load_7Scenes.center_poses(predict_pose, pose_avg_file)
        #     print('\n\n ================== \n pose_avg_stats_mode_pred_eval = {}, using {}'.format(args.pose_avg_stats_mode_pred_eval, 'pose_avg_stats_nerf_best.txt'))
        
        # elif args.pose_avg_stats_mode_pred_eval == 1: # seq01abs测试最佳
        ...
        #     predict_pose, pose_avg = load_7Scenes.center_poses(predict_pose, pose_avg_file)
        #     print('\n\n ================== \n pose_avg_stats_mode_pred_eval = {}, using {}'.format(args.pose_avg_stats_mode_pred_eval, 'seq01abs test best (pose_avg_stats_abs_999imgs_seq01and2-skip5.txt)'))

        # elif args.pose_avg_stats_mode_pred_eval == 2: # seq02abs测试最佳
        ...
        #     predict_pose, pose_avg = load_7Scenes.center_poses(predict_pose, pose_avg_file)
        #     print('\n\n ================== \n pose_avg_stats_mode_pred_eval = {}, using {}'.format(args.pose_avg_stats_mode_pred_eval, 'seq02abs test best (pose_avg_stats_abs12-999_all_skip_1_seq01.txt)'))

        # elif args.pose_avg_stats_mode_pred_eval == 3: # run_feature 在seq01abs测试最佳
        ...
        #     predict_pose, pose_avg = load_7Scenes.center_poses(predict_pose, pose_avg_file)
        #     print('\n\n ================== \n pose_avg_stats_mode_pred_eval = {}, using {}'.format(args.pose_avg_stats_mode_pred_eval, 'run_feature seq01abs test bes (pose_avg_stats_before_removetop12imgsfordso.txt)'))

        # elif args.pose_avg_stats_mode_pred_eval == 4: # run_feature pose_avg_stats_dso12-999imgs_skip5_seq01
        #     pose_avg_file = np.loadtxt('/home/jialu/zeroshot123cycle0524/data/7Scenes/heads/pose_avg_stats_dso12-999imgs_skip5_seq01.txt')
        #     predict_pose, pose_avg = load_7Scenes.center_poses(predict_pose, pose_avg_file)
        #     print('\n\n ================== \n pose_avg_stats_mode_pred_eval = {}, using {}'.format(args.pose_avg_stats_mode_pred_eval, 'pose_avg_stats_dso12-999imgs_skip5_seq01.txt'))

        # elif args.pose_avg_stats_mode_pred_eval == 5: # pose_avg_stats_dsoseq01_allimgs.txt
        #     pose_avg_file = np.loadtxt('/home/jialu/zeroshot123cycle0524/data/7Scenes/heads/pose_avg_stats_dsoseq01_allimgs.txt')
        #     predict_pose, pose_avg = load_7Scenes.center_poses(predict_pose, pose_avg_file)
        #     print('\n\n ================== \n pose_avg_stats_mode_pred_eval = {}, using {}'.format(args.pose_avg_stats_mode_pred_eval, 'pose_avg_stats_dso12-999imgs_skip5_seq01.txt'))

        # elif args.pose_avg_stats_mode_pred_eval == 6: # pose_avg_stats_dso_12-999imgs_seq01_and_02.txt
        #     pose_avg_file = np.loadtxt('/home/jialu/zeroshot123cycle0524/data/7Scenes/heads/pose_avg_stats_dso_12-999imgs_seq01_and_02.txt')
        #     predict_pose, pose_avg = load_7Scenes.center_poses(predict_pose, pose_avg_file)
        #     print('\n\n ================== \n pose_avg_stats_mode_pred_eval = {}, using {}'.format(args.pose_avg_stats_mode_pred_eval, 'pose_avg_stats_dso_12-999imgs_seq01_and_02.txt'))


        # elif args.pose_avg_stats_mode_pred_eval == 7: # pose_avg_stats_absseq01_skip1.txt
        #     pose_avg_file = np.loadtxt('/home/jialu/zeroshot123cycle0524/data/7Scenes/heads/pose_avg_stats_absseq01_skip1.txt')
        #     predict_pose, pose_avg = load_7Scenes.center_poses(predict_pose, pose_avg_file)
        #     print('\n\n ================== \n pose_avg_stats_mode_pred_eval = {}, using {}'.format(args.pose_avg_stats_mode_pred_eval, 'pose_avg_stats_absseq01_skip1.txt'))

        # elif args.pose_avg_stats_mode_pred_eval == 8: # pose_avg_stats_abs12-999_all_skip_1_seq02.txt
        #     pose_avg_file = np.loadtxt('/home/jialu/zeroshot123cycle0524/data/7Scenes/heads/pose_avg_stats_abs12-999_all_skip_1_seq02.txt')
        #     predict_pose, pose_avg = load_7Scenes.center_poses(predict_pose, pose_avg_file)
        #     print('\n\n ================== \n pose_avg_stats_mode_pred_eval = {}, using {}'.format(args.pose_avg_stats_mode_pred_eval, 'pose_avg_stats_abs12-999_all_skip_1_seq02.txt'))

        # elif args.pose_avg_stats_mode_pred_eval == 9: #pose_avg_stats_abs12-999_all_skip_5_seq01.txt
        #     pose_avg_file = np.loadtxt('/home/jialu/zeroshot123cycle0524/data/7Scenes/heads/pose_avg_stats_abs12-999_all_skip_5_seq01.txt')
        #     predict_pose, pose_avg = load_7Scenes.center_poses(predict_pose, pose_avg_file)
        #     print('\n\n ================== \n pose_avg_stats_mode_pred_eval = {}, using {}'.format(args.pose_avg_stats_mode_pred_eval, 'pose_avg_stats_abs12-999_all_skip_5_seq01.txt'))

        # elif args.pose_avg_stats_mode_pred_eval == 10: #pose_avg_stats_fromgit.txt
        #     pose_avg_file = np.loadtxt('/home/jialu/zeroshot123cycle0524/data/7Scenes/heads/pose_avg_stats_abs12-999_all_skip_1_seq02.txt')
        #     predict_pose, pose_avg = load_7Scenes.center_poses(predict_pose, pose_avg_file)
        #     print('\n\n ================== \n pose_avg_stats_mode_pred_eval = {}, using {}'.format(args.pose_avg_stats_mode_pred_eval, 'pose_avg_stats_fromgit.txt'))
    ...
    # pose_avg_fromgit = np.loadtxt('/home/jialu/zeroshot123cycle0524/data/7Scenes/heads/')
    # all_poses, pose_avg = center_poses(all_poses, pose_avg_fromgit)


    # pose_avg_from_file_abs_02 = np.loadtxt('/home/jialu/zeroshot123cycle0524/data/7Scenes/heads/')
