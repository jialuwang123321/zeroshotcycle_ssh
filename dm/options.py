...
def config_parser():
    ...
    # zeroshot
    parser.add_argument("--num_cycle",   type=int, default=2, help='number of cycle in zeroshot training frame')
    parser.add_argument("--real",   action='store_true', help='if use, ground truth will be 7Scenes DSO')
    parser.add_argument("--pose_avg_stats_mode",   type=int, default=0, help='load_7Scenes.py pose_avg_stats_mode') 
    parser.add_argument("--pose_avg_stats_mode_pred_eval",   type=int, default=-1, help='load_7Scenes.py pose_avg_stats_mode')     
    return parser