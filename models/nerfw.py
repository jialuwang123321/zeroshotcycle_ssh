...
def create_nerf(args):
    ...
    if args.no_grad_update== True:
        print('optimizer 1  , nerf optimizer =None')
        print_current_line()
        grad_vars = None
        optimizer = None
    else:
    ...
    # ckpts =['/home/jialu/zeroshot123cycle/logs/chess/nerfh/000600.tar'] # ['/home/jialu/zeroshot123cycle/logs/loop/nerfh/000600.tar']
    print('Found ckpts', ckpts)
    if len(ckpts) > 0 and not args.no_reload: #dfnet_unfreeze_nerf进来
        ckpt_path = ckpts[-1]
        ...
        print('Not loading nerf checkpoints in /home/jialu/zeroshot123cycle0524/models/nerfw.py!')
